...
console.log("Filter(hashtag): winstagram");
filterConfig = {
    hashtags: ['winstagram']
};
console.log(module.getPhotoPosts(0, 10, filterConfig));

console.log("Filter(hashtags): sport & winstagram");
filterConfig = {
    hashtags: ['winstagram', 'sport']
};
console.log(module.getPhotoPosts(0, 10, filterConfig));
...
console.log("Filter(date period, author): from 30.11.2012 to 18.03.2018, nepravskayak_");
filterConfig = {
    toDate: new Date('2018-03-18T23:59:59'),
    fromDate: new Date('2012-11-30T00:00:00'),
...
console.log("INCORRECT Filter(date period, author, hashtag): from 30.11.2012 to 18.03.2018, nepravskayak_, photocard");
filterConfig = {
    toDate: new Date('2018-03-18T23:59:59'),
    fromDate: new Date('2012-11-30T00:00:00'),
    author: 'nepravskayak_',
